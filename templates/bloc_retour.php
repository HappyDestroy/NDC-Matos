<?php if ($hide_association): ?>
      <div class="liste-matos">
        ...
        <ul>
          <?php foreach ($resultat['repartition']['retour'] as $entry): ?>
    ...
    <div class="bloc-container <?= $hide_association ? 'hide-association' : ''; ?>" id="bloc-container-retour">
      <?php foreach ($resultat['repartition']['retour'] as $personne => $entry): ?>
    ...
    <table class="repartition-table <?= $hide_association ? 'hide-association' : ''; ?>" id="repartition-table-retour">
      <thead>
        <tr>
          <th colspan="2">Personne retournant du local</th>
